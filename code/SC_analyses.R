...
#friends <- as.matrix(read.table("./data/SC_friends.csv", sep = ",", row.names = 1, header = TRUE))
#relatedness <- as.matrix(read.table("./data/SC_kinship.csv", sep = ",", row.names = 1, header = TRUE))
#sharing <- as.matrix(read.table("./data/SC_exchange.csv", sep = ",", row.names = 1, header = TRUE))
#work <- as.matrix(read.table("./data/SC_working.csv", sep = ",", row.names = 1, header = TRUE))
...
sharing <- as.matrix(read.table("./data/SC_exchange.csv", sep = ",", row.names = 1, header = TRUE))
work <- as.matrix(read.table("./data/SC_working.csv", sep = ",", row.names = 1, header = TRUE))
attractiveness <- as.matrix(read.table("./data/SC_attractiveness.csv", sep = ",", row.names = 1, header = TRUE))
distance <- as.matrix(read.table("./data/SC_physical_distance.csv", sep = ",", row.names = 1, header = TRUE))
pol_distance <- as.matrix(read.table("./data/SC_political_distance.csv", sep = ",", row.names = 1, header = TRUE))
wealth_distance <- as.matrix(read.table("./data/SC_wealth_distance.csv", sep = ",", row.names = 1, header = TRUE))
age_distance <- as.matrix(read.table("./data/SC_age_distance.csv", sep = ",", row.names = 1, header = TRUE))
atrakt_distance <- as.matrix(read.table("./data/SC_atrakt_dist.csv", sep = ",", row.names = 1, header = TRUE))
edu_distance <- as.matrix(read.table("./data/SC_edu_distance.csv", sep = ",", row.names = 1, header = TRUE))
bmi_distance <- as.matrix(read.table("./data/SC_bmi_distance.csv", sep = ",", row.names = 1, header = TRUE))
pv_distance <- as.matrix(read.table("./data/SC_pv_distance.csv", sep = ",", row.names = 1, header = TRUE))
dl_distance <- as.matrix(read.table("./data/SC_dl_distance.csv", sep = ",", row.names = 1, header = TRUE))
...
#code religion
att$Religion[att$Religion %in% c("CHRISTIAN", "EVANGELICAL","JEHOVAHS WITNESS")] <- "OTHER"
att$Religion[att$Religion == "UNKNOWN"] <- "NONE"
...
if(only_technicals==TRUE){
 return(p2)} else{
  ...
  df_SC = strand_caterpillar_plot(res_SC, submodel=c("Focal efffects: Out-degree","Target effects: In-degree","Dyadic effects","Other estimates"), normalized=FALSE, site="SC")
